...
export function NavBar() {
  ...
  return (
    <nav className={`fixed top-0 inset-x-0 z-50 flex items-center justify-between px-8 md:px-12 transition-all duration-700 ${navBgClass}`}>
      <div 
      ...
      <button 
        ...
        className={`p-2 ml-auto md:ml-0 rounded-full transition-colors duration-500 ${btnClass}`}
